...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private List<View> vTabItemList = new ArrayList<View>();
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			if (vTabItemList != null && vTabItemList.size() > 0) {
				addItenTab(i, vTabItemList.get(i));
	...
	private void addItenTab(final int position, View v) {
		View item = v;
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft, height - underlineHeight,
	...
	public void setItemTabView(List<View> item_list) {
		vTabItemList.clear();
		vTabItemList.addAll(item_list);
	}

	public List<View> getItemTabView() {
		return vTabItemList;
	}
